...
<div class="login-box">
  ...
  <div class="login-logo">
    <a href="index.php" style="color: yellow;">Sistem Informasi <br/><b>Perpustakaan Teknik Informatika</b></a>
  </div>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: yellow;"> Copyright &copy; Sistem Perpustakaan Teknik Informatika - <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
