                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lahir" value="<?= $user->tempat_lahir;?>" required="required" placeholder="Contoh : Brebes">
                                </div>
                                <div class="form-group">
                                    <label>Kelas</label>
                                    <input type="text" class="form-control" name="Kelas" value="<?= $user->Kelas;?>" required="required" placeholder="Contoh : VII A">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label>NIM</label>
                                    <input id="uintTextBox" class="form-control" value="<?= $user->NIS;?>" name="NIS" required="required" placeholder="Contoh : 15558">
                                </div>
                                <div class="form-group">
                                    <label>No HP</label>
                                    <input type="text"  value="<?= $user->NISN;?>" readonly class="form-control" name="NISN" required="required" placeholder="Contoh : 0103072761">
                                </div>
                                <div class="form-group">
