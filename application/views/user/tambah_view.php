                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lahir" required="required" placeholder="Contoh : Brebes">
                                </div>
                                <div class="form-group">
                                    <label>Kelas</label>
                                    <input type="text" class="form-control" name="Kelas" required="required" placeholder="Contoh : Teknik Informatika">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <label>NIM</label>
                                    <input id="uintTextBox" class="form-control" name="NIS" required="required" placeholder="Contoh : 55201200001">
                                </div>
                                <div class="form-group">
                                    <label>No HP</label>
                                    <input type="text" class="form-control" name="NISN" required="required" placeholder="Contoh : 087858216272">
                                </div>
                                <div class="form-group">
